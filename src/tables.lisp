...
(defun compile-enemies (&optional (pathname (merge-pathnames "Source/Tables/EnemyStats.ods" (project-root)))
                                  (output-pathname (merge-pathnames "Source/Generated/EnemyTables.s" (project-root)))
                                  index-pathname)
             ...
             (let ((string (cl-change-case:lower-case (symbol-name symbol))))
               (cl-ppcre:regex-replace-all
                ...
                (cl-ppcre:regex-replace-all
                 ...
                 "θ")
                "φ"))))
    (with-output-to-file (projection-tables.csv (merge-pathnames "Source/Generated/ProjectionTables.csv" (project-root))
                                                :if-exists :supersede)
      (with-output-to-file (projection-tables.s (merge-pathnames "Source/Generated/ProjectionTables.s" (project-root))
                                                :if-exists :supersede)
...
(defun write-inventory-tables (&optional (source-text (merge-pathnames "Source/Tables/Inventory.txt" (project-root)))
                                         (source-code (merge-pathnames "Source/Generated/InventoryLabels.s" (project-root)))
                                         (label "Item"))
...
(defun write-keys-tables ()
  ...
  (write-inventory-tables (merge-pathnames "Source/Tables/Keys.txt" (project-root))
                         (merge-pathnames "Source/Generated/KeyLabels.s" (project-root)) "Key"))

(defun write-flags-tables (&optional (source-text (merge-pathnames "Source/Tables/Flags.txt" (project-root)))
                                     (source-code (merge-pathnames "Source/Generated/FlagLabels.s" (project-root)))
                                     (forth-code (merge-pathnames "Source/Generated/FlagLabels.forth" (project-root))))
...
(defun write-characters-tables (&optional (spreadsheet-pathname (merge-pathnames "Source/Tables/NPCStats.ods" (project-root)))
                                          (source-pathname (merge-pathnames "Source/Generated/CharacterTables.s" (project-root))))
...
(defun write-orchestration (&optional (input (merge-pathnames "Source/Tables/Orchestration.ods" (project-root)))
                                      (output (merge-pathnames "Source/Generated/Orchestration.s" (project-root))))
...
(defun write-equipment-index (&optional (pathname (merge-pathnames "Source/Generated/EquipmentIndex.s" (project-root))))
