...
;;;     pkcon install  sbcl sudo dnf  install sbcl sudo  apt-get install
;;;     sbcl sudo yum install sbcl
...
(defvar *quicklisp-pgp-signature*
 ...
 Note  that (7/2016)  the  TLS certificate  for  QuickLisp.org has  the
...
(when *install-os-libs*
  ...
  (let ((packages (list (list "libpng" t t) (list "zlib-ng-compat" t t)
                        (list "SDL2" t t) (list "w3m") (list "curl")
                        (list "glibc" t t) (list "gcc") (list "gcc-c++")
                        (list "bzip2" t t) (list "expat" t t) (list "fontconfig" t t)
                        (list "freetype" t t) (list "glib2" t t) (list "ffi" t t)
                        (list "libgcc" t t) (list "ICE" t t) (list "SM" t t)
                        (list "libstdc++" t t) (list "libuuid" t t) (list "libX11" t t)
                        (list "qt" t t) (list "gimp") (list "nautilus")
                        (list "ptyxis")
                        (list "musescore")
                        (list "perl") (list "sed") (list "coreutils")
                        (list "binutils") (list "cyrus-sasl-lib" t t)
                        (list "keyutils-libs" t t) (list "krb5-libs" t t) (list "libcom_err" t t)
