...
(asdf:defsystem :skyline-tool
  ...
  ((:module "src"
    :components (
                 ...
                 (:file "decode-decal" :depends-on ("peek" "package" "decode-object"))
                 ...
                 (:file "oops" :depends-on ("package" "globals-copybook"))
                  (:file "package")
                  (:file "intv-palette-gen" :depends-on ("package" "graphics"))
                 ...
                 (:file "7800-scroll" :depends-on ("package"))
                 )))
  ...
  :components ((:module "tests"
                :components (
                             ...
                             (:file "interface-tests" :depends-on ("package"))
                              ...
                              (:file "intv-palette-tests" :depends-on ("package"))
