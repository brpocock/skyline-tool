...
(asdf:defsystem :skyline-tool
  ...
  ((:module "src"
    :components ((:file "package")
                 ...
                 (:file "atarivox" :depends-on ("package" "dynamics" "runner" "envelope-engine"))
                 ...
                 (:file "fountain" :depends-on ("package" "dynamics" "maps" "envelope-engine"))
                 (:module "gui"
                 ...
                 (:file "envelope-engine" :depends-on ("package" "dynamics"))
                 (:file "maps" :depends-on ("package" "dynamics" "prototypes" "envelope-engine"))
